...
# Fetch historical stock data for Oracle (ORCL)
ticker = 'ORCL'
...
print(f"Predicted Oracle stock price on {prediction_date.date()}: ${predicted_price_scalar:.2f}")
...
plt.title('Oracle Stock Price Prediction using Linear Regression')
plt.legend()
